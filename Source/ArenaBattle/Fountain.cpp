...
AFountain::AFountain()
{
	...
	static ConstructorHelpers::FobjectFinder<UStaticMesh>
		SM_WATER(TEXT("/Game/InfinityBladeGrassLands/Effects/FX_Meshes/Env/SM_Plains_Fountain_02.SM_Plains_Plains_Fountain_02"));
	...
	{
		Splash->SetStaticMesh(PS_SPLASH.Object);
	}
